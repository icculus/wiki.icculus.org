...
- On Android, argv0 should be a non-NULL pointer to a
  ...
  to the JNIEnv or Context past the call to [PHYSFS_init](PHYSFS_init)().
  If you pass a NULL here, [PHYSFS_init](PHYSFS_init) can still succeed,
  but [PHYSFS_getBaseDir](PHYSFS_getBaseDir)() and
...
- On Playdate, argv0 should be a non-NULL pointer to a PlaydateAPI struct.
  ...
  [PHYSFS_deinit](PHYSFS_deinit) is called. If you pass a NULL here,
